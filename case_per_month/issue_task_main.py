...
from case_per_month.middle_task_case import confluence, get_body, create_ecsdesk_data, get_issues
...
if __name__ == '__main__':
    ...
    # ********************************** 注意：此处jql语句一定要替换 *************************************
    ecsdesk_data_list = create_ecsdesk_data(get_issues(jira_settings.JQL_ECSDESK_TASK))
    ...
    cf.update_page(
        ...
        page_id=904986625,
        title="2021-1-16",
        body=get_body(ecsdesk_data_list, cse_data_list, jira_settings.TASK_TEMPLATE_NAME))
